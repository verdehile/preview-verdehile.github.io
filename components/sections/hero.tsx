  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-gradient-to-b from-primary/20 to-transparent rounded-full blur-3xl opacity-40"></div>
      ...
      <div className="max-w-4xl w-full text-center space-y-8 relative z-10">
        ...
        >
          ...
          <div className="w-32 h-1.5 bg-gradient-to-r from-primary to-accent mx-auto rounded-full"></div>
        </div>
        ...
        >
          <p className="text-2xl sm:text-3xl font-heading font-600 text-primary">Personalized Nutrition Delivery</p>
        </div>
        ...
        >
          <p className="text-lg sm:text-xl text-foreground/70 max-w-2xl mx-auto leading-relaxed">
            Get fit on your schedule. Personalized meal plans, flexible delivery, and a dedicated agent to keep you on
            track. No more guessing about macros or calories.
          </p>
        </div>

        <div
          className={`${isLoaded ? "animate-fade-in" : "opacity-0"} flex flex-col sm:flex-row gap-4 justify-center`}
          style={{
            animationDelay: "0.7s",
          }}
        >
        ...
        <div className="pt-8 opacity-0 animate-fade-in" style={{ animationDelay: "0.9s" }}>
